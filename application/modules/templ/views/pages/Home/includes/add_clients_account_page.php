...
<div style="width: 500px;
    ...
    <table style="margin-right:260px;">
        <tr>
            <td style="width: 150px;"><label class="container"> &nbsp&nbsp&nbsp{{x.location_name}}
      
      
      <span class="checkmark"></span>
      </label></td>
      <td><input type="checkbox" ng-model="x.selected" value={{x.location_id}} /> </td>
        </tr>
    </table>
