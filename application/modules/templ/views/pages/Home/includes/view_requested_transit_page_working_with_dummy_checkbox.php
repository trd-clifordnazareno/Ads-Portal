...
<div style="margin-top:13px; margin-left: 5%;" id="demo"><input type="checkbox" ng-click="toggleAll()" class="chkbx" ng-model="isAllSelected">

 <div style="margin-left: 30; position: absolute; margin-top: -1.5%;">Select all &nbsp&nbsp&nbsp&nbsp<button ng-click="approve()" class="btn btn-success" style="margin-top:1px;">Approve All</button></div></div>
 <input type="checkbox" ng-true-value="none" ng-click="untoggleAll()" ng-model="clearMe">
 <input type="checkbox" ng-model="all">asdasdasdadad 
 ...
 <input type="checkbox" ng-click="toggleAlls($event.target.checked)" ng-model="checkall"> Check all --{{checkall}}
                        ...
                        <div class="container">
                             <div class="row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        <input type="checkbox" name="foo" ng-model="client.selected" class="double" value={{client.photo_name}} style="margin-left:50px; margin-top: -70px; position: absolute;" ng-change="optionToggled()" ng-checked="all"/> 
                                                        <input ng-model="client.checked" type="checkbox" id="{{client.saved_photo_id}}" ng-checked="all">{{client.photo_name}}



                                                        <input type='checkbox' ng-model="item.checked" ng-click="checkboxClicked(item, $event.target.checked)"> {{item.phot}}-- {{item.checked}}
