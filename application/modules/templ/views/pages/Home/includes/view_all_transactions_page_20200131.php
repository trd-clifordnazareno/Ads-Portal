...
<h3 style="margin-left: 90px; margin-bottom: -10px; font-family: monospace;"><b>client name : {{client_name}}</b></h3></br>
<h3 style="margin-left: 90px; margin-bottom: -10px; font-family: monospace;"><b>Start Of Billing : {{start_date_billing}}</b></h3></br>
<h3 style="margin-left: 90px; margin-bottom: -10px; font-family: monospace;"><b>End Of Billing : {{end_date_billing}}</b></h3></br>
<h3 style="margin-left: 90px; margin-bottom: -10px; font-family: monospace;"><b>no of units : {{no_of_units}}</b></h3> </br>
<h3 style="margin-left: 90px; margin-bottom: -10px; font-family: monospace;"><b>no of approves : {{no_of_success}}</b></h3></br>
<h3 style="margin-left: 90px; position: absolute; margin-bottom: -10px; font-family: monospace;"><b >no of pending : {{no_of_units - no_of_success}}</b></h3></br>
...
<h3 style="margin-left: 90px; margin-bottom: -10px; font-family: monospace;"><b>Prepared By : <span style="text-decoration-line: underline; text-decoration-style: solid;">Ivy Sanchez</span></b></h3></br>
<div><p style="margin-left: 19%; margin-bottom: -10px; font-family: monospace; margin-top: -9; font-size: x-large; font-weight: 900; color: red;">Accounting Officer</p></div>
                        ...
                        <div class="container" style="height: 600px;">
                             <div class="row">
                                                    ...
                                                    <a href="<?php echo base_url();    ?>/Uploads/2020/{{client_name}}/{{x.location_name}}/{{'transits'}}/{{client.item_number}}/{{client.photo_name}}" target="_blank">
                                                        ...
                                                        <div style="margin-top: -35%;margin-left: 9%;font-size: 190px;position: absolute;">&#10004;</div>
                                                        </div>
