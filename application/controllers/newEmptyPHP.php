<style>
    ...
    @media only screen and (max-width: 10700px){
        #txtfname{
            width:579px;
            margin-left: -0px;
        }
...
<div id="id01" class="w3-modal">
 <div class="w3-modal-content w3-card-4 w3-animate-zoom">
  <header class="w3-container w3-blue"><meta http-equiv="Content-Type" content="text/html; charset=utf-8"> 
...
<!--<div id="count_name_loc_content"></div>-->
<div class="box">
 <div class="box-header">       
     <div class="box-body table-responsive">
         <h3 class="box-title" style="margin-left:43%;"><b style="color:red;"><div id="count_name_loc_content"></div>
         ...
         foreach($session_user_data as              $value => $key){
                                                 if( $value == "client_loc_id"         ){
                                                $corporate_name = $key;
                                                 }
                                        
                                             }  //echo $corporate_name;//var_dump         ($get_data_in_table_loc_report);
                                             //end new
                                             
                                             
                                             $var_corporate_name = $corporate_name;
                                             ...
                                             //new location loop
                                             $var_loc_code = $data->location_code;
                                             foreach($get_data_in_table_loc_report as $data_playlist){
                                                 $location_code_playlist = $data_playlist->location_code;
                                                if($location_code_playlist == $var_loc_code && $var_corporate_name == $data_playlist->clients_code){
                                                    // transfer
                                                    $exploded_loc_code = explode("-", $data->location_name); 
                                                    if($exploded_loc_code[2] == "S1"|| $exploded_loc_code[1] == "S1" || $exploded_loc_code[4] == "S1" || $exploded_loc_code[3] == "S1"){
                                                         $loc_name_explode = $exploded_loc_code[0] . " " . $exploded_loc_code[1];
                                                        
                                                        if($exploded_loc_code[1] == "CEBU"){
                                                        	if($exploded_loc_code[3] == "S1"){
                                                        	$loc_name_explode = "SEAPORT CEBU PIER3 ";/*$exploded_loc_code[0] . " " . $exploded_loc_code[1] . " " . $exploded_loc_code[2] . " " /*. $exploded_loc_code[3]*/;
                                                        	}else if($exploded_loc_code[3] == "1"){
                                                        	$loc_name_explode = /*$exploded_loc_code[1]*/ "SEAPORT" . " " . $exploded_loc_code[1] . " " . $exploded_loc_code[2] . "" .$exploded_loc_code[3];
                                                        	}else{
                                                        	$loc_name_explode = $exploded_loc_code[1] . " " . $exploded_loc_code[2] . " " .$exploded_loc_code[3];
                                                        	}
                                                        }else if($exploded_loc_code[0] == "DIPOLOG"){
                                                        	$loc_name_explode = "AIRPORT " . $exploded_loc_code[0];
                                                        }else if($exploded_loc_code[0] == "ORMOC"){
                                                        	$loc_name_explode = "SEAPORT " . $exploded_loc_code[0];
                                                        }
                        ...
                        <?php
                                             ...
                                             //end new location loop
                                                                                              ...
                                                                                              ?>
         <font color='black' size=3 style='font-family: unset;font-weight: 800; font-size:20px;'><b>NUMBER OF YOUR LOCATIONS : </b></font> <font size=3 color='red' style='font-family: unset;font-weight: 3000;'><b style='font-weight: 900; font-size: x-large;'><?php echo $num_loc;    ?></b></font>
         
         
         
         
<!--DIGITAL SIGNAGES--></b></h3>    
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" aria-describedby="example2_info">
                                        <thead>
                                            <tr style="border-bottom: 3px solid #000;">
                                                ...
                                                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending"><b>VIEW HERE</b></th>
 ...
 //new
                                                ...
                                                if($location_code_playlist == $var_loc_code && $var_corporate_name == $data_playlist->clients_code){
                                                    ...
                                                    if($exploded_loc_code[2] == "S1"|| $exploded_loc_code[1] == "S1" || $exploded_loc_code[4] == "S1" || $exploded_loc_code[3] == "S1"){
                                                        ...
                                                        if($exploded_loc_code[1] == "CEBU"){
                                                        	...
                                                        	if($exploded_loc_code[2] == "PIER1"){
                                                        	        $loc_name_explode = "SEAPORT CEBU PIER1 ";/*$exploded_loc_code[0] . " " . $exploded_loc_code[1] . " " . $exploded_loc_code[2] . " " /*. $exploded_loc_code[3]*/;
                                                        	    }else if($exploded_loc_code[2] == "PIER4"){
                                                        	       $loc_name_explode = "SEAPORT CEBU PIER3 ";/*$exploded_loc_code[0] . " " . $exploded_loc_code[1] . " " . $exploded_loc_code[2] . " " /*. $exploded_loc_code[3]*/; 
                                                        	    }
                                            ...
                                            >
					<img src="http://richmedia.com.ph/rmni/js/img/Tv.png" style="width: 50px; background-color:white;">
                                            </button>
...
//}
                 ...
                 <!---->
                 <?php /*foreach($session_user_data as $value => $key){
                 if( $value == "corporate_name"){
                $corporate_name = $key;
                 }
            
                 }  echo $corporate_name;//var_dump($get_data_in_table_loc_report); *//*foreach($get_data_in_table_loc_report as $data_loc_playlist){echo $data_loc_playlist->sequence;}*/ ?>
                 <!---->
            </div>
        </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"><!--style="width: 860px; margin-left: -60px;"-->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="btnsv"><div id="output"><div id="error">Connect</div></div></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="myModals">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <b><!--THREAD--></b> <div id="loadcon">asdasdas</div>
          <p style="margin-bottom: -30px;">
              </br> 
              <textarea  id="txtfname" style="height: 400px; float: both; background-color: white; position: sticky;" width="400" disabled onfocus="removeTextAreaWhiteSpace()"><?php
/*$text = trim($trd->thread_msg);
$textAr = explode("\n", $text);
...
?></textarea>
        ...
        <input type="text" class="input-sm" id="client_code_name" style="width: 0px; text-align: center; color:white;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <select class="form-control" id='thread_client' style="width: 500px;">
...
<script>
 $(document).ready(function(){
    $('#xxx tbody tr  td').on('click',function(){
    $("#myModals").modal("show");
    
    $("#txtfname").val($(this).closest('tr').children()[0].textContent);  
    $("#client_code_name").val($(this).closest('tr').children()[1].textContent);
...
<script>
    ...
    <script>
        ...
        <script>
    $(document).ready(function(){
       $("#count_name_loc_content").load("<?php echo site_url();    ?>/failuretoair/failuretoair/count_name_loc");
    });
    </script>
    ...
    $(document).ready(function(){
        $("#save_thread").click(function(){
            ...
            $.ajax({
                url : "<?php echo site_url();    ?>/view_Running_Status/view_Running_Status/save_new_thread/",
                type : "post",
                data : datas,
                success : function(msg){
                ...
                //$("#upload_image").show();
                    ...
                    $.ajax({
                        url: '<?php echo site_url();   ?>/crawler/crawler/upload_image_crawler', // point to server-side controller method
 ...
 /*$(document).ready(function(){
     setInterval(function(){ 
        datas = {
                data : $("#client_code_name").val(),
                ajax : 1
            };
            $.ajax({
                url : "http://richmedia.com.ph/rmni/index.php/view_running_status/view_running_status/get_client_images/",
                type : "post",
                data : datas,
                success : function(msg){
                    $("#loadcon").html(msg);
...
<script>
                                /*$(document).ready(function(){
                                    $("#view_note").click(function(){
                                        ...
                                        $.ajax({
                                            url : "http://richmedia.com.ph/rmni/index.php/view_running_status/view_running_status/view_note",
                                            type : "post",
                                            data : datas,
                                            success : function(msg){
                                                $("#view_note_page").html(msg);
                                                //alert("ok");
                                            }
                                        });
                                    });
