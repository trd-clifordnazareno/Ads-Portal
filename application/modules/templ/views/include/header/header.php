<html style="height: auto;"><head>
  <script src="<?php echo base_url(); ?>/scripts/js/angular.min.js"></script>
  <script src="<?php echo base_url(); ?>/scripts/js/angular-route.js"></script>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
   ...
   body {
      ...
      <?php if($print_condition == 1){   ?>
      <button class="btn btn-block btn-primary btn-lg" onclick="myFunction()">Print</button>
      <?php  }   ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><center>Richmeida Portal</center></span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/admin/home#!/view_account" class="nav-link">
                  <i class="far fa-user nav-icon"></i>
                  <p>View Clients Accounts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/admin/locations#!/" class="nav-link">
                &nbsp<i class="fa fa-university"></i>
                  <p>&nbsp&nbsp Locations</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/admin/photo#!/" class="nav-link">
                &nbsp<i class="fa fa-camera"></i>
                  <p>&nbsp&nbsp Photos</p>
                </a>
              </li>
            </ul>
          </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"><?php echo $navigation_page; ?></a></li>
              <li class="breadcrumb-item"><a href="#"><?php echo $sub_navigation_page; ?></a></li>
