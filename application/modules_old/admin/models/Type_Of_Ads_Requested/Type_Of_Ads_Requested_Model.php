...
class Type_Of_Ads_Requested_Model extends MY_Model{
	...
	{
		$this->db->from("type_of_ads_requested toar");
	}
	...
	{
		$this->db->where(array('toar.enabled' => 1));
	}
	...
	function insert_table($data){
		$this->db->insert("type_of_ads_requested",$data);
	...
	function insert_batch_table($data){
		$this->db->insert_batch("type_of_ads", $data); 
	}
