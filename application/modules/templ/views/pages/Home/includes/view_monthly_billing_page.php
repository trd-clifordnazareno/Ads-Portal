                        ...
                        <td class="sorting_1">
                            ...
                            <td class="sorting_1">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="btn-group" ng-if="usertype == 'admin'">
                                                &nbsp&nbsp&nbsp<button type="button" class="btn btn-info" ng-click="view_client_contract_locations(x.client_contract_id, x.monthly_start_billing, x.monthly_end_billing)">Locations</button>
                                                <button type="button" class="btn btn-info dropdown-toggle dropdown-hover dropdown-icon" data-toggle="dropdown">
                                                    <span class="sr-only">Toggle Dropdown</span>
                                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <div class="col-md-4">
                                            <div class="btn-group">
                                                &nbsp&nbsp&nbsp<button type="button" class="btn btn-info" ng-click="view_all_transactions(x.client_contract_id, x.monthly_start_billing, x.monthly_end_billing)">client</button>
                                                <button type="button" class="btn btn-info dropdown-toggle dropdown-hover dropdown-icon" data-toggle="dropdown">
                                                    <span class="sr-only">Toggle Dropdown</span>
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href="#" ng-click="view_all_transactions(x.client_contract_id, x.monthly_start_billing, x.monthly_end_billing)">View</a>
                                                    </div>
                                                </button>
                                            </div>
                                        </div>
